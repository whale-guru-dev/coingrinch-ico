...
var currencies = {
	...
	"USDT": {"shortName": "USD", "longName": "Tether Dollar", "showChartButton": false},
	"BTC": {"shortName": "BTC", "longName": "Bitcoin Price", "marketCapKey": "bitcoin", "showChartButton": true, "compareTo": ["USDT"], "color": "#F4911F"},
	"ETH": {"shortName": "ETH", "longName": "Ethereum Price", "marketCapKey": "ethereum", "showChartButton": true, "compareTo": ["USDT", "BTC"], "color": "#6187A6"},
};
var ranges = {
	"2d": 2,
	"1w": 7,
...
function showChartCurrency() {
	...
	//DAO
	if(currChart == "BTC"){
		lastValueStr = g_btc_price;
	}else if(currChart == "ETH"){
		lastValueStr = g_eth_price;
	}
	docTitleFirstPart = lastValueStr + " " + currencies[currChart].shortName;
	lastValueStr += " " +currencies[currRel].shortName + "/" + currencies[currChart].shortName;
	//!DAO
	...
	if(currRel != "USDT")
	 ...
	 chartData.subtitle.text = "latest: " + "<span style=\"color:black;\">" + lastValueStr + "</span>";
