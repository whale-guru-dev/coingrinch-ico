...
<div class="page-content-wrapper">
	<div class="page-content">
		<h3 class="page-title uppercase bold"> <i class="fa fa-desktop"></i> VIEW KYC UNVERIFIED USERS</h3>
		<hr>
			...
			<div class="col-md-12">
				...
				<div class="portlet box red">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-list"></i>  KYC UNVERIFIED USERS LIST
						</div>
						@if($search!='')
						<div class="actions">
...
<div class="modal fade" id="nameModal" tabindex="-1" role="dialog">
	...
	<div class="modal-content">
		...
		<form action="{{url('/Admins/Search')}}" method="post">
			{{ csrf_field() }}
			<input type="hidden" name="sType" value="kunverified">
